...
* The original package name 'AS241S5_AEJ_40-be' is invalid and this project uses 'AS241S5_AEJ_40_be' instead.
...
* [Spring Data Reactive MongoDB](https://docs.spring.io/spring-boot/3.5.13/reference/data/nosql.html#data.nosql.mongodb)
